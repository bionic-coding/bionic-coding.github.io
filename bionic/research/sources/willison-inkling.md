...
raw_path: research/raw/2026-08-01/willison-inkling/
previous_captures: []
static: true
tags: [inkling, thinking-machines, open-weights, apache-2-0, training-data, independent-review]
---

16th July 2026 - Link Blog

**[Inkling: Our open-weights model](https://thinkingmachines.ai/news/introducing-inkling/)** ([via](https://news.ycombinator.com/item?id=48924912) Hacker News) Mira Murati's Thinking Machines Lab just released their first open-weights model. Inkling is "a Mixture-of-Experts transformer with 975B total parameters, 41B active" - an Apache-2.0 licensed multimodal model trained on 45 trillion tokens of text, images, audio and video.
...
![[../raw/2026-08-01/willison-inkling/inkling-pelican-10264f8e.jpg]]
...
Posted [16th July 2026](https://simonwillison.net/2026/Jul/16/) at 3:35 pm

Tags: ai, generative-ai, llms, training-data, pelican-riding-a-bicycle, llm-release

## Capture gaps

* **This is a link post, not a review.** Willison's own assessment is two sentences
  ("a lot to like… good to see the US open weights ecosystem gain a new viable
  contender"). The substantive claims — 975B-A41B, Apache 2.0, 45T tokens — are quoted
  from Thinking Machines' own announcement and model card, neither of which is captured
  here. Capture the model card directly before citing those specs as verified.
* **No benchmarks appear on this page at all.** Thinking Machines' own framing is that
  Inkling "is not the strongest overall model available today, open or closed" — the
  citable fact is the disclaimer, not a ranking.
* **The training-data documentation is the story.** Willison's point is that the card
  and its data documentation are unusually thin for a US lab; the two quoted paragraphs
  are the whole substance. Useful as a concrete example when writing about training-data
  transparency.
* Site chrome removed: subscribe prompts, AWS sponsor line, "Recent articles", the
  sponsorship footer, and the year-archive list.
