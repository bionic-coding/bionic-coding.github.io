...
raw_path: research/raw/2026-08-01/willison-kimi-k3/
previous_captures: []
static: true
tags: [kimi, open-weights, independent-review, benchmarks, llm-pricing]
---
...
![[../raw/2026-08-01/willison-kimi-k3/kimi-3-pelican-19ba00d9.jpg]]
...
Posted [16th July 2026](https://simonwillison.net/2026/Jul/16/) at 8:19 pm
...
* **Announcement date conflicts across sources.** Willison dates the K3 announcement to
  **16 July 2026** ("this morning"). GIGAZINE
  ([[research/sources/qwen3-8-open-weight-announcement]]) says K3 was "released on July 17,
  2026", and [[research/sources/state-of-open-source-local-llms-july-2026]] says July 7.
  Willison is a same-day first-hand account and is the strongest of the three on this
  point; the July 7 figure is the outlier and should not be used.
* **Every benchmark figure here is second-hand or vendor-run.** The Moonshot table is
  self-reported; the Elo/cost numbers are quoted from an Artificial Analysis tweet, not
  a methodology page. Willison's own contribution is the hands-on cost and token
  measurements, which are first-hand.
* **The 85-token hidden system prompt is Willison's inference**, drawn from a Hacker
  News token count, and he flags it as "suggesting there may be" — not confirmed.
* Site chrome removed: subscribe prompts, AWS sponsor line, "More recent articles",
  the sponsorship footer, and the year-archive list.
