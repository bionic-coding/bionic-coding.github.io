---
title: "Qwen3.8-2.4T-A95B — Hugging Face model card (open-weights release)"
slug: qwen3-8-2-4t-a95b-open-weights-release
type: source
...
raw_path: research/raw/2026-08-15/qwen3-8-2-4t-a95b-open-weights-release/
previous_captures: []
static: false
tags: [qwen, alibaba, open-weights, model-release, benchmarks, licensing, architecture]
---

Repository page metadata: org Qwen · tags Text Generation, Transformers, Safetensors, qwen3_5_moe_text, conversational, Eval Results · **License: qwen3.8-max** (custom license, named after the API model) · downloads last month 6,381 · model size **2.4T params** · tensor type BF16 · chat template included · inference provider listed: Together AI · 2 finetunes, 18 quantizations, 4 Spaces derived · collection "Qwen3.8" (4 items) · HF eval-results widget: DeepSWE 56.6, WildClawBench Overall 56.2 (Avg Time 708), SWE-bench Pro 67.7, GPQA Diamond 92.6, HLE 43.6.
