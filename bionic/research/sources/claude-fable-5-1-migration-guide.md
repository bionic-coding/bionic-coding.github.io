...
slug: claude-fable-5-1-migration-guide
type: source
...
raw_path: research/raw/2026-09-01/claude-fable-5-1-migration-guide/
previous_captures: []
static: false
tags: [anthropic, fable-5-1, api, migration, preserved-thinking, tool-use]
---

Claude Platform documentation page, transcribed from the author's paste of the page source on 2026-09-01 (the release day). The same URL was fetched by `web-to-markdown` into the raw capture; the paste is the cleaner text and is used as the body.
...
The page's multi-language code groups (cURL, CLI, TypeScript, C#, Go, Java, PHP, Ruby) are reduced to the Python sample above. The full set is in the raw capture's `extracted.md` and `source.html`. Cross-page links were reduced to their link text; targets are in the raw capture.
