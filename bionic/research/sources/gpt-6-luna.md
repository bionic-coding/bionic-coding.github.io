...
raw_path: research/raw/2026-09-22/gpt-6-luna/
previous_captures: []
static: false
...
> Captured via the page's clean `.md` export (`https://developers.openai.com/api/docs/models/gpt-6-luna.md`), which OpenAI serves by appending `.md` to any doc URL. A rendered-HTML capture of the same page was also taken (`source.html`, `gpt-6-luna-*.png`) but the `.md` export is the body of this page.
...
- No benchmark figures appear on this doc page — the model page never carries benchmarks.
- No release-date or announcement-post link appears on this page. `static: false` (doc pages change) and there is no dated snapshot notice.
