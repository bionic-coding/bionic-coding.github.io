...
raw_path: research/raw/2026-09-03/openai-path-to-astra/
previous_captures: []
static: true
tags: [openai, gpt-6, astra, safety, cybersecurity, preparedness-framework, alignment, hugging-face-incident]
---

# Path to Astra: critical capabilities and frontier safeguards

_OpenAI, September 1, 2026. Filed under Safety and Security; page tags "Framework", "Alignment"; author "OpenAI". `openai.com` returns 403 to scripted fetches, so this was captured 2026-09-03 through a Playwright browser session: `source.html` is the rendered DOM, `extracted.txt` the page's main-content text. Two charts in the body are described in their captions below; their data was not captured._
...
> [chart, data not captured] "ExploitBench - Internal Port (June–August 2026)": success rate (0–40%) against output tokens (0–140k) for Astra and GPT-5.6 Sol. Caption: "Astra results shown reflect capabilities with Daybreak Blue access, not the default production configuration."
...
> [paraphrased] The page's "Keep reading" strip links three related posts, none captured: "Daybreak for Frontline Defenders" (Security, Sep 3, 2026), "Safety overview: GPT-6 Astra" (Safety, Sep 3, 2026), and "The Hugging Face incident and the road ahead" (Security, Aug 26, 2026).

## Capture gaps

- The two charts (ExploitBench Internal Port success-vs-tokens; the auto-review and honeypot pair) were captured as rendered HTML only; no underlying figures beyond the 56% honeypot rate stated in prose.
- The in-text links ("our learnings" from the incident, "For GPT-5.6", "exploit a poor configuration") point to pages not captured.
- The Astra system card the post defers to was not published at the time of capture.
