# DeepSeek-V4-Pro-0813 — Hugging Face model card

- **source_url:** https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro-0813
- **fetched_at:** 2026-08-15
- **note:** DeepSeek-V4-Pro-0813 official open-weights release (MIT license, 1.7T params) — HF model card with benchmark table, DSpark speculative decoding, and serving instructions.
...
- Org: deepseek-ai (DeepSeek, 142k followers)
- Model: deepseek-ai/DeepSeek-V4-Pro-0813 — like 481, Community 17
- Tags: Text Generation, Transformers, Safetensors, deepseek_v4, conversational, 8-bit precision, fp8
- arxiv: 2606.19348
- **License: mit**
- Downloads last month: 19,945
- Model size: **1.7T params**; Tensor type: BF16 · I64 · F32 · F8_E4M3 · I8
- Inference provider listed: Novita
- Model tree: 1 finetune, 6 quantizations
- Collection: DeepSeek-V4 (8 items, updated 2 days ago, 827)
- Paper: "DeepSeek-V4: Towards Highly Efficient Million-Token Context Intelligence", arXiv 2606.19348 (HF page shows "Published Apr 26", 35 upvotes)

---

# DeepSeek-V4-Pro-0813

[Technical Report](https://arxiv.org/abs/2606.19348) · [Homepage](https://www.deepseek.com/) · [Chat](https://chat.deepseek.com/)
