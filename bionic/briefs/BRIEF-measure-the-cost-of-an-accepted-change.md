...
slug: measure-the-cost-of-an-accepted-change
type: brief
status: draft                # draft | published
created_at: 2026-09-22
updated_at: 2026-09-22       # bumped on every edit
authors: ["Mark Madsen"]
tags: [research, workflow, cost, field-notes]
related_adrs: []             # ADR ids that reference this brief (back-populated by audit-docs)
---

# Measure the cost of an accepted change in the current coding workflow
