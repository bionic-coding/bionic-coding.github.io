[📚 LLM-as-a-Judge: a Complete Guide on Using LLMs for Evaluations. Get your copy](<https://www.evidentlyai.com/llm-judge-guide>)![](660ef16a9e0687d9cc2747cf_vector-59525e22.svg)

[![](66180fbf4f40e9ed73ca2d39_evidently_ai_lo-047feb49.png)](<https://www.evidentlyai.com/>)

[GitHub](<https://github.com/evidentlyai/evidently>)

![Icon](664abe8f5bd7dda2d12a1e6d_list-bold-72c6b7e4.svg)
...
[ Header H2](<https://www.evidentlyai.com/llm-guide/llm-as-a-judge>)

[Header H3](<https://www.evidentlyai.com/llm-guide/llm-as-a-judge>)

[Header H4](<https://www.evidentlyai.com/llm-guide/llm-as-a-judge>)

[Header H5](<https://www.evidentlyai.com/llm-guide/llm-as-a-judge>)
...
> 💡 **Want to build your own LLM judge?**   
> We built Evidently, an open-source library for LLM evals with 25M+ downloads. You can use it to create and tune your own LLM judges. [Give it a ⭐️ on GitHub](<https://github.com/evidentlyai/evidently>) to support the project!   
>   
> **💻 Want a practical example?** Watch this [video tutorial](<https://www.youtube.com/watch?v=kP_aaFnXLmY&list=PL9omX6impEuNTr0KGLChHwhvN-q3ZF12d&index=6>) with code to get started.
...
![Icon](6621380c5a4fc308c069f93c_iconmonstr-chec-d7f68bed.svg)
...
[Start for free](<https://www.evidentlyai.com/register>)[Or try open source![Icon](660ef16a9e0687d9cc27473e_Group_209-bfefcbfc.svg)](<https://github.com/evidentlyai/evidently>)

[![](685d563de771eac09c5b2284_llm_20judge_20g-9c9aa259.png)](<https://www.evidentlyai.com/llm-judge-guide>)
...
![LLM judge](66f7172913e46c4ec934e09d_66f700a47de5d26-3705ab7a.jpeg)
...
![LLM judge example](66f7172913e46c4ec934e0ab_66f700c09c0c6b0-904bc15e.png)
...
![Evidently LLM judge report](66f7172913e46c4ec934e09a_66f700daec211ed-1dbc0f9c.png)
...
![Evidently LLM judge dashboard](66f7172a13e46c4ec934e1a3_66f700fe41b3d93-4732e625.png)
...
![LLM-as-a-judge effectiveness](66f7172913e46c4ec934e11e_66f7012155f8084-40e8ed7a.jpeg)
...
![Generating LLM responses](66f7172a13e46c4ec934e1a6_66f70163f67be0a-bf9e5c7a.png)
...
![LLM-as-a-judge process](66f7172913e46c4ec934e118_66f70192027e07a-6cd70953.png)
...
![LLM-as-a-judge pairwise compaison](66f7172913e46c4ec934e0a3_66f701adc5733bb-6af4af4e.png)
...
![LLM-as-a-judge paper](66f7172913e46c4ec934e0b5_66f701d8c535ef9-629374a2.png)
...
![LLM-as-a-judge evaluation by criteria](66f7172913e46c4ec934e115_66f701fcc535ef9-76143048.png)
...
![LLM conversation evaluation](66f7172913e46c4ec934e11b_66f7024c41b3d93-8ce70b5c.png)
...
![Evaluating LLM response correctness based on reference answer](66f7172913e46c4ec934e0c7_66f7026ce96747f-7078833c.png)
...
> **Simplified prompt:__**_Compare the generated RESPONSE to the REFERENCE answer. Evaluate if the generated response correctly conveys the same meaning, even if the wording is different. Return one of these labels: 'Correct’ or 'Incorrect.'_****
...
![LLM-as-a-judge Wix example](66f7172913e46c4ec934e0ae_66f7029c040f34e-fc8c71c6.png)
...
![Evaluating LLM answer quality considering the question](66f7172913e46c4ec934e0b8_66f702c16a87d9c-caef0f16.png)
...
> **Simplified prompt:__**_Evaluate the following RESPONSE based on the given QUESTION. A complete response is one that fully addresses all parts of the question. Return one of the following labels: 'Complete' or 'Incomplete.'_

**3\. Scoring context relevance in RAG.**

![Scoring context relevance in RAG](66f7172913e46c4ec934e0a0_66f71381bb97c00-2ebd1915.png)
...
![Evaluating hallucinations in RAG](66f7172913e46c4ec934e121_66f713a01be3337-d24db146.png)
...
> **Simplified prompt:__**_Evaluate the following RESPONSE for faithfulness to the CONTEXT. A faithful response should only include information present in the context, avoid inventing new details, and not contradict the context. Return one of the following labels: 'Faithful' or 'Not Faithful’._
...
![How to create an LLM judge](66f7172913e46c4ec934e125_66f713c6b6ec50d-f1fa8f23.png)
...
![LLM judge labeling](66f7172913e46c4ec934e0c1_66f713e448f8910-a0492b7f.png)
...
![LLM judge evaluation prompt](66f7172913e46c4ec934e0a7_66f713fdb1291b4-4f858903.png)

We’ll share more tips on prompt writing in the next section. 

> **Want a code tutorial?** Check out this [guide](<https://www.evidentlyai.com/blog/llm-as-a-judge-tutorial>) for a step-by-step example of creating an evaluation dataset and designing an LLM judge. 
...
![Evaluate an LLM judge](66f7172913e46c4ec934e0cc_66f71421b71973e-1961c2fc.png)
...
![Evaluate the quality of an LLM judge](66f7172913e46c4ec934e0bb_66f714443eda4a6-e243a1f4.png)
...
![LLM binary evaluation prompt](66f7172913e46c4ec934e0be_66f71596db1d63b-d343eae6.png)
...
![LLM valuation criteria](66f7172913e46c4ec934e112_66f715c5669859a-29fc129c.png)
...
![LLM prompt recommendation](66f7172913e46c4ec934e0c4_66f7163c669859a-813ebc68.png)
...
![LLM chain of thought example](66f7172913e46c4ec934e10f_66f715e6303df70-38a3bd45.png)
...
> **Want to get started with examples**? We implemented many of these tips in the [Evidently open-source library](<https://github.com/evidentlyai/evidently>). It offers LLM evaluation templates that already include repeatable parts like formatting and reasoning. You can add your criteria in plain text or use built-in prompts for inspiration. Check out the docs to [get started](<https://docs.evidentlyai.com>). To create judges with no-code, [sign up for a free account](<https://www.evidentlyai.com/register>) on Evidently Cloud.
...
![LLM tracing with Evidently](66f725ec7e7b03c94032074a_66f71abdcbb1880-ca0437da.png)
...
![LLM observability dashboard with Evidently](66db39e963aa17758dca4624_66db32ff5499050-35ebcd58.gif)
...
> **LLM Observability.** You could create this workflow step by step — set up logging, storage, evaluation jobs, dashboards, and alerts. Purpose-built LLM observability tools like **Evidently Cloud** streamline the process. You can [**sign up for free**](<https://www.evidentlyai.com/register>)**** and get started quickly without the need to spin up all the infrastructure yourself.
...
### **[fs-toc-omit]** Pros of LLM judges

![Pros of using LLM judges](66f725ed7e7b03c940320765_66f724bb70ec670-c63bcd11.jpeg)
...
### **[fs-toc-omit]** Cons of LLM judges

![Cons of LLM judges](66f725ed7e7b03c9403207c4_66f724f82f8ab6f-937e1c75.jpeg)
...
![Sentiment distribution example](66f725ec7e7b03c940320747_66f7255670ec670-fbba7fcd.png)
...
**LLM-as-a-Judge** is a scalable alternative to human labeling. It is perfect for tasks where there’s no single right answer and for production monitoring. If you are working on complex AI systems like RAG or AI agents, you’ll need such task-specific evaluations tuned to your criteria and preferences. 

That’s why we built [Evidently](<https://www.evidentlyai.com>). Our open-source library (trusted with over 25 million downloads!) makes it easy to set up and run LLM-as-a-Judge evaluations and other tests. You can use different evaluator LLMs and test judges against your own labels to better align them.
...
[Explore docs![Icon](660ef16a9e0687d9cc27473e_Group_209-bfefcbfc.svg)](<https://docs.evidentlyai.com/introduction>)

[**Free course on LLM****evaluations**![Icon](660ef16a9e0687d9cc27473e_Group_209-bfefcbfc.svg)](<https://www.evidentlyai.com/llm-evaluation-course-practice>)

WRITTEN BY

![](6626658917335110bb02d790_62bcd97b59ab872-4b642d71.jpeg)

#### [Elena SamuylovaCo-founder and CEOEvidently AI](<https://www.evidentlyai.com/authors/elena-samuylova>)

share on

[![LinkedIn logo](660ef16a9e0687d9cc27475f_Group_2068-64688568.svg)](<https://www.linkedin.com/>)[![Twitter logo](665498e176df469709a54190_x-logo_20_1_-eef9530b.svg)](<https://twitter.com/>)[![Facebook logo](660ef16a9e0687d9cc274774_Group_2065-02f694d3.svg)](<https://facebook.com>)

## Read next

[![](6720de6e8c728f1d1fadb0c5_02_cheerful-rob-12f33d79.jpg)LLM benchmarksLLM benchmarks are standardized tests for LLM evaluations. This guide covers 30 benchmarks from MMLU to Chatbot Arena, with links to datasets and leaderboards.](<https://www.evidentlyai.com/llm-guide/llm-benchmarks>)

[![](67b5f31f0b5be1101ededae4_happy-robot-wit-948ca32a.jpg)LLM evaluation metricsThis guide explains different automated LLM evaluations methods, including semantic similarity, classification and ranking metrics, LLM-based evaluators and deterministic tests, and shows when to use them.](<https://www.evidentlyai.com/llm-guide/llm-evaluation-metrics>)
...
[GitHub](<https://github.com/evidentlyai/evidently>)[Explore docs](<https://docs.evidentlyai.com/introduction>)

[![Evidently AI logo](664ac309d9d1086b0e8309f9_evidently_20log-32e83360.png)](<https://www.evidentlyai.com/>)
...
[LLM and AI agents ](<https://www.evidentlyai.com/llm-testing>)[Predictive ML systems](<https://www.evidentlyai.com/ml-monitoring>)
...
[Docs](<https://docs.evidentlyai.com/>)[GitHub](<https://github.com/evidentlyai/evidently>)[Community](<https://www.evidentlyai.com/community>)[Contact us](<https://www.evidentlyai.com/contact-us>)
...
[![](660ef16a9e0687d9cc274742_Group_2027-b0038a1c.svg)](<https://www.linkedin.com/company/evidently-ai/>)[![Twitter logo](664f62d9e2ffd7e31ffae6c8_x-logo-duotone_-7a8e5ea1.svg)](<https://twitter.com/EvidentlyAI>)[![Discord logo](664f6316d09cc4b5e975db27_discord-logo-du-b2be2108.svg)](<https://discord.com/invite/PyAJuUD5mB>)[![YouTube logo](664f634afd92ff37de706ab9_youtube-logo-du-695187be.svg)](<https://www.youtube.com/c/evidentlyai>)
