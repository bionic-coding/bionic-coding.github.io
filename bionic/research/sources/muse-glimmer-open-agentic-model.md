...
slug: muse-glimmer-open-agentic-model
type: source
...
raw_path: research/raw/2026-08-25/muse-glimmer-open-agentic-model/
previous_captures: []
static: true
tags: [meta, muse-glimmer, open-weights, local-models, agents, apache-2-0, quantization]
---
...
![[../raw/2026-08-25/muse-glimmer-open-agentic-model/media-ebf9683b.bin]]

_Table comparing Muse Glimmer 30B with Gemma4 31B and Qwen3.6 27B across agentic, coding, multimodal, safety, and reasoning benchmarks._
...
![[../raw/2026-08-25/muse-glimmer-open-agentic-model/media-4a9be3c4.bin]]

_Table comparing full precision, K-Quant-Dynamic, and K-Quant-17GB by accuracy degradation and target hardware memory._
...
![[../raw/2026-08-25/muse-glimmer-open-agentic-model/media-f9679763.bin]]

_Bar chart showing DFlash speculative decoding increasing Muse Glimmer decode speed by 3.1 times on RTX 5090, 1.8 times on M5 Max, and 1.5 times on M4 Max._
...
> [paraphrased] Page navigation chrome and the site footer were stripped.

Three figures were downloaded as extension-less binaries (`media-*.bin`) and are referenced above by their raw-capture paths; their captions are reproduced verbatim from the page's `alt` text, but **the numeric contents of the two benchmark tables were not captured** — they are images, not markup. The linked evaluation report (`research.meta.ai/static/muse-glimmer-methodology`) and the Hugging Face model card were not captured; a second ingest would be needed for the benchmark numbers themselves.
