...
**Bionic coding** throws away the code and keeps the discipline. The code was never the thing worth preserving. The invariants were. So pin those, make them executable, and let the implementation be regenerated as freely as you recompile.
