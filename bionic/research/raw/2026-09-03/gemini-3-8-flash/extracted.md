...
[ Tulsee Doshi Senior Director, Product Management ](<https://blog.google/authors/tulsee-doshi/>)
...
![a hero image reading "Gemini 3.8 Flash and 3.8 Flash Cyber"](gemini-3-8_flash__blog__header__1.width--14c6cb8a.webp)
...
Building on the momentum of [3.7 Flash](<https://blog.google/innovation-and-ai/models-and-research/gemini-models/introducing-gemini-3-7-flash/>) from three weeks ago and marking our third Flash release in only six weeks, today we’re introducing Gemini 3.8, our best reasoning & coding model yet, at the same speed and low cost of 3.7. Gemini 3.8 introduces 2 variants:
  ...
  * **Gemini 3.8 Flash:** our most intelligent workhorse model, delivering significant improvements from 3.7 Flash across software engineering, agentic tasks, and critical, multi-step reasoning in specialized domains. It is available at the same introductory price [1](<https://blog.google/innovation-and-ai/models-and-research/gemini-models/3-8-flash-and-3-8-flash-cyber/#footnote-1>) as 3.7 Flash at $0.75 per million input tokens and $3.75 per million output tokens.
...
![comparison chart showing Gemini 3.8 Flash and other models](gemini-3.8-flash__evals__table_l.width-1-2042047c.webp)
...
![chart showing Gemini 3.8 Flash DeepSWE v1.1](gemini-3-8-flash__evals__deepswe.width-1-13478184.webp)
...
![chart showing Gemini 3.8 Flash Vals Finance Agent v2](gemini-3.8-flash_evals_vals-finan.width--ad6318f4.webp)

![a chart showing Gemini 3.8 Flash Harvey's Legal Agent Benchmark](gemini-3.8-flash_evals_harveys-le.width--dfd8608c.webp)

![a chart showing Gemini 3.8 Flash HLE-Verified](gemini-3.8-flash_evals_HLE_light.width-1-459f6bd7.webp)
...
![a chart showing Gemini 3.8 Flash Cyber CyberGym Pass@1](gemini-3.8-cyber__evals__cybergy.width-1-0c638860.webp)
...
![Chart showing Gemini 3.8 Flash Cyber real world vulnerability discovery](gemini-3.8-cyber__evals__rw-vuln.width-1-f6770f1d.webp)
...
![Chart showing Gemini 3.8 Flash Cyber StaticBench Pass@1 vs Cost Per Rollout](gemini-3-8-cyber__evals__cwe-ben.width-1-17c5e4f9.webp)
...
![quote from David Slater, Founder and Chief Architect, Armadin](gemini-3-8-flash__testimonial__ar.width--7d70d389.webp)

![quote from Charlie Sestito, Director, Office of the CTO, Palo Alto Networks](gemini-3-8-flash__testimonial__pa.width--17811bbd.webp)

![quote from Mayank Upadhyay, CSTO, Snowflake](gemini-3-8-flash__testimonial__sn.width--32644cad.webp)

![quote from Gal Nagli, Head of Threat Exposure, Wiz](gemini-3-8-flash__testimonial__wi.width--a27d5def.webp)
...
![a chart showing Gemini 3.8 Flash Cyber Gray Swan IPI Benchmark](gemini-3.8-flash_evals_attack__l.width-1-181aae6b.webp)
...
[ ![](gemini-3-8__fairwind-.2e16d0ba.fill-300x-456bc73b.webp) Safety & Security  Proactive cyber defense for governments and enterprises  By Four Flynn  ](<https://blog.google/innovation-and-ai/technology/safety-security/fairwind-program/>) [ ![](August_AI_Recap_socia.2e16d0ba.fill-300x-194a909a.webp) AI  The latest AI news we announced in August 2026  By News from Google Team  ](<https://blog.google/innovation-and-ai/technology/google-ai-updates-august-2026/>) [ ![](agentic-video___keywo.2e16d0ba.fill-300x-034bb9a5.webp) Gemini models  Introducing agentic video understanding with Gemini  By Rohan Doshi & Mario Lučić  ](<https://blog.google/innovation-and-ai/models-and-research/gemini-models/introducing-agentic-video-in-gemini/>) [ ![](Omni_1-1_Flash_hero.2e16d0ba.fill-300x30-1bd06096.webp) Developer tools  Gemini Omni 1.1 Flash lets you build with more control  By Anish Nangia & Alisa Fortin  ](<https://blog.google/innovation-and-ai/technology/developers-tools/build-with-gemini-omni-1-1-flash/>) [ ![](gemini_3-5_transcribe.2e16d0ba.fill-300x-9e5a6c38.webp) Gemini models  Intelligent transcription with Gemini 3.5 Transcribe  By Diego Melendo Casado & Luke Leonhard  ](<https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-5-transcribe/>) [ ![](thumbnail_BfIj9lP.2e16d0ba.fill-300x300.-f1a7609a.webp) Gemini models  What does “full-stack” AI actually mean?  By Lindsey Lanquist  ](<https://blog.google/innovation-and-ai/models-and-research/gemini-models/what-full-stack-development-means/>)
